...
export const ReturnTimelineObject = (props) => {
    ...
    return (calculatedWidth !== 0
            ...
            ? <g
                ...
                onMouseOver={() => setHighlighted(!highlighted)}
                onMouseOut={() => setHighlighted(!highlighted)}
            >
                <rect
                    x={timespan[0]}
                    y={index * 20 + 10}
                ...
                >
                    <tspan x="1">{label}</tspan>
                    <tspan x="1" dy="1.2em">{`(${formatDate(timespan[0])} - ${formatDate(timespan[1])})`}</tspan>
                </text>
            </g>
